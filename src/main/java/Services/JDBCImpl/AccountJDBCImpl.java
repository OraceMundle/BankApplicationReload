...
public class AccountJDBCImpl extends JDBCMainConfiguration implements IAccountService {
    ...
    public void addAccountJDBC(Account account) throws Exception {
     ...
     String insertAccount = "INSERT INTO account(balance, loan_amount, monthly_install, date_opened, date_closed, trn, worker_id) "
    ...
    public Account getAccountJDBC(int accountnumber) throws Exception {
       ...
       while(rs.next()){
        ...
        account.setCustomerTRN(rs.getInt("trn"));
